...
\name{Yunlong Li}{}
\title{Technischer Lösungsingenieur}
...
\cventry{Sept. 2022–Juni 2026}
        {Master, Computer Linguistics \& Neuroinformatics}
...
\cventry{Sept. 2020–Juli 2022}
        ...
        {}
        {\begin{itemize}
\item Betreuenden Professor bei der Koordination mit Industriepartnern für Projektanforderungen und Deployment unterstützt.
\item Bei der Teamorganisation mitgewirkt und an Forschungsrichtungsplanung und Meilensteinverfolgung teilgenommen.
\item An der Entwicklung von Algorithmen für multimodale Datenfusion und SAAS-Plattform-Design mitgewirkt.
\item Bei der Erstellung von Projektpräsentationen und Roadshow-Materialien für Stakeholder unterstützt.
\item An der Erreichung von COP 7,0 und 36 \% Energieeinsparung durch ML- \& IoT-Optimierung mitgewirkt.
\end{itemize}
\textbf{Schlüsselwörter}: HLK, IoT, Industriekoordination, ML-Optimierung}

\section{Sprachen}

\cvline{Mandarin}{Muttersprache oder zweisprachig}
\cvline{Kantonesisch}{Muttersprache oder zweisprachig}
\cvline{Englisch}{Verhandlungssichere Kenntnisse}
...
\cvline{Software \& Infrastruktur}{Erfahren \hfill \textbf{Schlüsselwörter}: Python, C/C++, JavaScript / TypeScript, Cloudflare D1 / R2 / Workers, Oracle Cloud, Docker / Nginx, N8N}
...
\cventry{Jan. 2025–Feb. 2025}
        {Automatisierte Multi-Account-Reddit-Operationen mittels Playwright-Browser-Automatisierung.}
        {Reddit-Gruppensteuerungs-Automatisierungssystem}
        {}
        {}
        {\begin{itemize}
\item Gruppensteuerungs-Automatisierungssystem für Reddit mit Playwright für Multi-Account-Browser-Orchestrierung entwickelt.
\item Content-Posting, Engagement-Workflows und Account-Verwaltung über mehrere Reddit-Konten gleichzeitig automatisiert.
\item Anti-Erkennungsstrategien und menschenähnliche Verhaltenssimulation zur Wahrung der Account-Integrität implementiert.
\end{itemize}
\textbf{Schlüsselwörter}: Playwright, Browser-Automatisierung, Gruppensteuerung, Python}
